    ...
    questions: [
      ...
      },
      {
        ...
        interactiveDiagram: {
          layout: "flow",
          nodes: [
            { type: "state", label: "Static Structure" },
            { type: "transition", label: "modeled by" },
            { type: "slot", index: 0, slotType: "state" }
          ]
        },
        cards: [
          { id: "ans-class", type: "document", label: "Class Diagram" },
          { id: "ans-state", type: "document", label: "Statechart Diagram" },
          { id: "ans-use", type: "document", label: "Use Case Diagram" }
        ],
        answer: ["ans-class"],
    ...
    questions: [
      {
        ...
        cards: [
          { id: "chg-event", type: "process", label: "Event/Message" },
          { id: "chg-time", type: "process", label: "Class instantiation" },
          { id: "chg-attr", type: "process", label: "Attribute change" }
        ],
        answer: ["chg-event"],
      ...
      },
      {
        ...
        interactiveDiagram: {
          layout: "flow",
          nodes: [
            { type: "state", label: "Good Event Name" },
            { type: "transition", label: "like" },
            { type: "slot", index: 0, slotType: "process" }
          ]
        },
        cards: [
          { id: "ans-e1", type: "process", label: "onSubmit" },
          { id: "ans-e2", type: "process", label: "Loading" },
          { id: "ans-e3", type: "process", label: "Pending" }
        ],
        answer: ["ans-e1"],
